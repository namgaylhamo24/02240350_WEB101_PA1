...
export default function ProfileInfo({ profile }: ProfileProps) {
  return (
    <div className="flex flex-col items-center pt-12 pb-6">
      <div className="w-24 h-24 rounded-md bg-green-500 border-2 border-red-400 flex items-center justify-center text-white text-4xl">
        {profile.avatar}
      </div>
    ...
    <Button className="mt-6 bg-pink-500 hover:bg-pink-600 text-white rounded-full px-8 py-1 text-sm font-medium">
      Edit Profile
    </Button>
    </div>
  )
